    ...
    class VendingMachine {
      ...
      public void ioC50() {
        try {
        P0.writeBytes("0"); P0.seek(0);
        P0.writeBytes("1"); P0.seek(0);
        P1.writeBytes("0"); P1.seek(0);
        P2.writeBytes("0"); P2.seek(0);
        } catch (Exception e) {
      ...
      public void ioTWICE(){
    	  try{
    		  TWICE.writeBytes("1"); TWICE.seek(0);
    		  TWICE.writeBytes("0"); TWICE.seek(0);
    	  }catch(Exception e) {
      ...
      public void ioRET(){
    	  try{
    		  RET.writeBytes("1"); RET.seek(0);
    		  RET.writeBytes("0"); RET.seek(0);
    	  }catch(Exception e) {
      ...
      public void ioRST(){
    	  try{
    		  RST.writeBytes("1"); RST.seek(0);
    		  RST.writeBytes("0"); RST.seek(0);
    	  }catch(Exception e) {
      ...
      public void ioACK(){
    	  try{
    		  ACK.writeBytes("1"); ACK.seek(0);
    		  ACK.writeBytes("0"); ACK.seek(0);
    	  }catch(Exception e) {
      ...
      public void ioSTB(){
    	  try{
    		  STB.writeBytes("1"); STB.seek(0);
    		  STB.writeBytes("0"); STB.seek(0);
    	  }catch(Exception e) {
      ...
      public void ioClose() {
        try {
        P0.close(); P1.close(); P2.close(); STB.close(); RET.close();
        ACK.close(); TWICE.close(); R0.close(); R1.close(); E0.close();
        E1.close(); E2.close(); SEL0.close(); SEL1.close();  RST.close(); 
        } catch (Exception e) {
